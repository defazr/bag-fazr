        ...
        <div className="space-y-6 text-[15px] text-gray-700 dark:text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <Link href="/article/where-to-buy" className="font-medium underline underline-offset-2 hover:text-gray-900 dark:hover:text-white transition">전국 판매처 총정리</Link>
              를 참고하세요.
            </p>
          </section>
